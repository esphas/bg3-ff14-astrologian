...
### 1 级
    ...
    烧灼: 戏法, 18m, 动作, 魅力豁免, 令敌人获得3回合烧灼debuff（每回合D8戏法光耀）
    凶星: 一环, 18m, 动作, 魅力豁免, 3d8光耀, 每升环+1d8
...
### 2 级
    ...
    时间膨胀: 职业动作, 短休充能, 18m, 附赠动作, 令一名盟友拥有的来自你的占星术状态的剩余持续时间延长2回合
...
### 3 级
    ...
    吉星相位: 二环, 18m, 动作, 2d4+施法调整值 生命值, 每升环+1d4
        ...
        黑夜学派额外效果: 赋予 2d10 临时生命值, 每升环+1d10
...
### 6 级
    ...
    天星冲日: 职业动作, 短休充能, 9m, 附赠动作, 令自身及附近盟友拥有的来自你的占星术状态的剩余持续时间延长1回合, 并使附近敌人眩晕1回合
...
### 7 级
    ...
    阳星相位: 四环, 9m, 动作, 2d4+施法调整值 生命值, 每升环+1d4
        白昼学派额外效果: 3回合内, 每回合额外恢复 2d4 生命值, 每升环+1d4
        黑夜学派额外效果: 赋予 2d10 临时生命值, 每升环+1d10
    沉稳咏唱: 职业动作, 长休充能, 附赠动作, 1回合内, 你不会被蛮力移动, 专注豁免获得优势,
        可以在即将受到伤害或击退/吸引时作为反应动作使用
    营救: 职业动作, 长休充能, 18m, 附赠动作, 将一名目标吸引到自己身边

    先天禀赋精通: 可以使用反应动作, 在生命值较低的盟友即将受到伤害时, 对其使用先天禀赋
...
### 14 级
    ...
    天星交错: 职业动作, 18m, 附赠动作, 每场战斗一次, 根据学派赋予不同效果
...
### 17 级
    ...
    [阳星相位]变为[阳星合相]: 基础治疗量/白昼学派效果/黑夜学派效果 分别提高 1d4/1d4/1d10
